    ...
    return(
        <nav className='nav'>
            ...
            <div className='buttons'>
                ...
                <Link to='/Home'>  
                <br/><button id='homeTableHeaderColor' type="button" className="btn">Home</button>
                </Link>

                <Link to='/Create'>
                <br/><button id='homeTableHeaderColor' type="button" className="btn">Create</button>
                </Link>

                <Link to='/Leaderboard'>  
                <br/><button id='homeTableHeaderColor' type="button" className="btn">Rank</button>
                </Link>
