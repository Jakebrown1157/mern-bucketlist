            ...
            <Form onSubmit={handleSubmit} >
                ...
                <Form.Group className="mb-3" controlId="activity">
                    <Form.Label>Bucket List Activity</Form.Label>
                        ...
                        <Form.Control type='text' name='name' placeholder='name' onChange={handleChange}></Form.Control>
                </Form.Group>
                ...
                <Form.Group className="mb-3" controlId="Difficulty">
                    ...
                    {/* <Form.Control type='number' name='difficulty' value={difficulty} onChange={(e) => setDifficulty(e.target.value)} placeholder='Difficulty' min={0} max={3}></Form.Control> */}
                        <Form.Control type='number' name='difficulty' placeholder='difficulty' onChange={handleChange}></Form.Control>
                </Form.Group>
                ...
                <Form.Group className="mb-3" controlId="description">
                    <Form.Label>Description</Form.Label>
                        ...
                        <Form.Control type='text' name='description' placeholder='description' onChange={handleChange}></Form.Control>
                </Form.Group>
